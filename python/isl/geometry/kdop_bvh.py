import isl.geometry.kdop as KDOP
import math
...
def make_bvh(T, N):
    ...
    ### Complicates the input too much to refit at this stage. The BVH is never used without being refitted anyway.
    #refit_bvh(X, T, tree, K, velocity, dt, envelope)
    ###
