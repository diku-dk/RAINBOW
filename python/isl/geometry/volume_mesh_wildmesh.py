...
class Options:
    ...
    def __init__(self):
        ...
        """
        self.stop_quality = 10.0       # "Specify max AMIPS energy for stopping mesh optimization"
        ...
        self.edge_length_r = 1. / 20.  # "Relative target edge length l_r. Absolute l = l_r * diagonal_of_bbox"
...
def create_mesh(V, F, options, VB=None, TB=None, AB=None):
    ...
    """
    tetra = wm.Tetrahedralizer(stop_quality=options.stop_quality,
    ...
    mesh = tetra.get_tet_mesh(smooth_open_boundary=options.smooth_open_boundary,
