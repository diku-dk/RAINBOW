"""Scientific auto-tuning for all soft-body timestepper/backend combinations.
...
def main() -> None:
    ...
    parser.add_argument("--settings-output", type=Path, default=Path("output/autotune/scientific/auto-tuned-settings.json"))
    ...
    args.output = args.output or Path(f"output/autotune/scientific/soft_{args.case}_autotune.csv")
